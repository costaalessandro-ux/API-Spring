...
//anotação para realizar o teste.
@DataJpaTest
// essa anotação diz para o spring não usar o banco de dados em memoria;
...
class MedicoRepositoryTest {
    ...
    @Test // essa notação diz para o spring que é um metodo de teste.
